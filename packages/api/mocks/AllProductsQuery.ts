...
export const productSearchPage1Count5Fetch = {
  info: 'https://ecmSearchAccount--workspace.vtexcommercestable.com.br/api/io/_v/ecm-search/product_search/trade-policy/1?page=1&count=5&query=&sort=&fuzzy=auto&locale=en-US&hideUnavailableItems=false&simulationBehavior=skip',
  init: undefined,
