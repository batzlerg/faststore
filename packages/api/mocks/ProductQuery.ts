...
export const productSearchFetch = {
  info: 'https://ecmSearchAccount--workspace.vtexcommercestable.com.br/api/io/_v/ecm-search/product_search/trade-policy/1?page=1&count=1&query=sku%3A64953394&sort=&fuzzy=auto&locale=en-US&hideUnavailableItems=false&simulationBehavior=skip',
  init: undefined,
