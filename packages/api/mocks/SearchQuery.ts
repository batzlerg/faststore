...
export const productSearchCategory1Fetch = {
  info: 'https://ecmSearchAccount--workspace.vtexcommercestable.com.br/api/io/_v/ecm-search/product_search/category-1/office/trade-policy/1?page=1&count=5&query=&sort=&fuzzy=auto&locale=en-US&hideUnavailableItems=false&simulationBehavior=skip',
  init: undefined,
...
export const attributeSearchCategory1Fetch = {
  info: 'https://ecmSearchAccount--workspace.vtexcommercestable.com.br/api/io/_v/ecm-search/facets/category-1/office/trade-policy/1?page=1&count=5&query=&sort=&fuzzy=auto&locale=en-US&hideUnavailableItems=false&simulationBehavior=skip',
  init: undefined,
  options: { storeCookies: expect.any(Function) },
  result: {
    facets: [
