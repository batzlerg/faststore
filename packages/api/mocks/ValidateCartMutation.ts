...
export const productSearchPage1Count1Fetch = {
  info: 'https://ecmSearchAccount--workspace.vtexcommercestable.com.br/api/io/_v/ecm-search/product_search/trade-policy/1?page=1&count=1&query=sku%3A2737806&sort=&fuzzy=auto&locale=en-US&show-invisible-items=true&hideUnavailableItems=false',
  init: undefined,
  options: { storeCookies: expect.any(Function) },
  result: {
    products: [
